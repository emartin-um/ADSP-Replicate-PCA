...
3. **Replicate Splits** - Within-group variation analysis
4. **Eigenvector Plots** - PC scatter plots by technical factors
5. **Summary** - Overall quality assessment

## Key Metrics

### For Technical Replicates:
- **Early PCs (1-40)**: Should show near-zero variation (SD < 1e-4)
...
3. Show variation mainly due to **technical factors**:
   - PCR-free vs standard library prep
   - Sequencing round differences
   - Batch effects

Any significant variation suggests potential technical quality issues.
